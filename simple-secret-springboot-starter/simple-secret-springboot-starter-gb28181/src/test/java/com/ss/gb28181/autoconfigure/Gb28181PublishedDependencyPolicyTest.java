...
class Gb28181PublishedDependencyPolicyTest {
    private static final Path SOURCE_POM = Path.of(System.getProperty("basedir"), "pom.xml");

    @Test
    void productionDependenciesShouldContainOnlyCoreAndAutoConfigure() throws Exception {
        assertThat(productionDependencies(SOURCE_POM)).containsExactlyInAnyOrder(
                "com.ss:simple-secret-plugin-gb28181",
