 ...
 *
 * @author JunPzx
 * @since 2025/8/21 14:17
 */
public class DefaultHttpBeforeAccessHandler extends AbstractCallbackHandler implements HttpBeforeAccessHandler {
     ...
     */
    @Override
    public void handle(MK_PARSER parser, String path, MK_SOCK_INFO sender) {
