 ...
 *
 * @author JunPzx
 * @since 2025/8/21 11:40
 */
public class DefaultHttpRequestHandler extends AbstractCallbackHandler implements HttpRequestHandler {
     ...
     */
    @Override
    public void handle(MK_PARSER parser, MK_HTTP_RESPONSE_INVOKER invoker, IntByReference consumed, MK_SOCK_INFO sender) {
        consumed.setValue(0);
    }
