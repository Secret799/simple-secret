...
/** 海康录像文件轮询和按日月历组装。 */
final class HikvisionPlaybackCalendarQuery {
    private static final int MAX_RECORDING_PERIODS = 10_000;

    private final HikvisionNativeApi nativeApi;
    private final Duration timeout;

    HikvisionPlaybackCalendarQuery(HikvisionNativeApi nativeApi, Duration timeout) {
        this.nativeApi = nativeApi;
        this.timeout = timeout;
    }

    List<PlaybackTimePeriodDomain> execute(
